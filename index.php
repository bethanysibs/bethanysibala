   ...
   <nav class="navbar navbar-expand-lg">
      <div class="container">
         ...
         <div class="col-lg-4 col-4 featured-border-bottom">
            <a href="index.php" class="navbar-brand mx-auto mx-lg-0 d-none d-sm-block">Bethany Sibala</a>
            <p class="featured-text d-none d-sm-block"><small>Frontend Developer | Project Manager </small></p>
            <p class="featured-text d-block d-sm-none pt-3"><small>Bethany Sibala </small></p>
         </div>
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-lg-5 col-12 position-relative">
                  ...
                  <img src="images/beth.png" class="hero-image img-fluid" alt="">
               </div>
            </div>
         </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-6 col-12">
                  <img src="images/beth_1.jpg" class="about-image img-fluid" alt="">
               </div>
               <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                  <div class="about-thumb">
                     <div class="section-title-wrap d-flex justify-content-end align-items-center mb-4">
                        <h2 class="text-white me-4 mb-0">My Story</h2>
                        <img src="images/beth.png" class="avatar-image img-fluid" alt="">
                     </div>
                     <h3 class="pt-2 mb-3">A little bit about me...</h3>
                     <p>Hi! I'm Beth. I just love everything about the internet especially working on websites. I enjoy working, I enjoy accomplishing tasks, it makes me feel productive and fulfilled. I have been working for the tech world for 7 years now. I develop WordPress sites, static HTML sites, websites using HTML, CSS3 and PHP. I am currently focused on the frontend development as I love making things pretty! I also have experience in other CMS like Wix, Shopify, Webflow, etc. Given that I develop websites, I also make sure that my websites are optimized and SEO-friendly. </p>
                     <p> I do have experience in Team Management and Project Management, so I can also manage teams and projects if you need assistance in the management area. As I have been changing job positions over the years, I have developed a different set of skills and I am still excited to learn more and add them to my skill set.</p>
                     <p>I am driven and I can multi-task, I make sure that my tasks are being addressed right away. I am very respectful, kind, patient, and understanding but at the same time also proactive. I guess these traits are important to succeed in this industry and these are also important to gain the trust of the clients.</p>
                     <p>I am hoping to be able to share my skills with you and with everyone else.</p>
                  </div>
               </div>
            </div>
         </div>
                  ...
                  <div class="profile-thumb">
                     ...
                     <div class="profile-body">
                        <p>
                           ...
                           <span>Bethany Sibala</span>
                        </p>
                        <p>
                           <span class="profile-small-title">Birthday</span> 
                           <span>March 28, 1991</span>
                        </p>
                        <p>
                           <span class="profile-small-title">Phone</span> 
                           <span><a href="tel: 305-240-9671">+63 917 707 7257</a></span>
                        </p>
                        <p>
                           <span class="profile-small-title">Email</span> 
                           <span class="inline-block text-wrap"><a href="mailto:bethanysibala.work@gmail.com">bethanysibala.work@gmail.com</a></span>
                        </p>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="about-thumb">
                     <div class="row">
                        ...
                        <div class="col-lg-6 col-6 featured-border-start featured-border-bottom ps-5 py-2">
                           ...
                           <p class="featured-text">Lorem Ipsum</p>
                        </div>
         ...
         <div class="container">
            <div class="row align-items-center">
               ...
               <div class="col-lg-3 col-4 ms-auto clients-item-height">
                  <img src="images/clients/connet.png" class="clients-image img-fluid" alt="">
                  <center><small class="projects-tag">Connet One Technology Limited </small></center>
               </div>
               <div class="col-lg-3 col-4 clients-item-height">
                  <img src="images/clients/ripple.webp" class="clients-image img-fluid" alt="">
                  <center><small class="projects-tag">Ripple VAs </small></center>
               </div>
               <div class="col-lg-3 col-4 clients-item-height">
                  <img src="images/clients/upwork-fb.png" class="clients-image img-fluid" alt="">
                  <center><small class="projects-tag">Upwork </small></center>
               </div>
               <div class="col-lg-3 col-4 clients-item-height">
                  <img src="images/clients/lumikha.png" class="clients-image img-fluid" alt="">
                  <center><small class="projects-tag">Atelier Lumikha </small></center>
               </div>
            </div>
         </div>
      </section>
                        ...
                        <div class="services-thumb">
                           <div class="d-flex flex-wrap align-items-center border-bottom mb-4 pb-3">
                              ...
                              <div class="services-price-wrap ms-auto">
                                 <p class="services-price-text mb-0">₱25,000</p>
                     ...
                     <div class="col-lg-6 col-12">
                        <div class="services-thumb services-thumb-up">
                           <div class="d-flex flex-wrap align-items-center border-bottom mb-4 pb-3">
                              ...
                              <div class="services-price-wrap ms-auto">
                                 <p class="services-price-text mb-0">₱12,000</p>
                                 <div class="services-price-overlay"></div>
                              </div>
                           </div>
                           <p>Branding is the overarching idea or image of your company that is associated with your product and might define it in the eyes of your customers.</p>
                           <a href="#" class="custom-btn custom-border-btn btn mt-3">Discover More</a>
                           <div class="services-icon-wrap d-flex justify-content-center align-items-center">
                     ...
                     <div class="col-lg-6 col-12">
                        <div class="services-thumb">
                           <div class="d-flex flex-wrap align-items-center border-bottom mb-4 pb-3">
                              ...
                              <div class="services-price-wrap ms-auto">
                                 <p class="services-price-text mb-0">₱30,000</p>
                                 <div class="services-price-overlay"></div>
                              </div>
                           </div>
            ...
            <div class="row">
               ...
               <div class="col-lg-3 col-md-6 col-12 ps-lg-0">
                  <div class="contact-info d-flex flex-column">
                     ...
                     <p class="mb-2">
                        Bethany is a professional web developer. Feel free to get in touch with me.
                     </p>
                     <strong class="site-footer-title d-block mt-4 mb-3">Email</strong>
                     <p>
                        <a href="mailto:bethanysibala.work@gmail.com">
                        bethanysibala.work@gmail.com
                        </a>
                     </p>
                     <strong class="site-footer-title d-block mt-4 mb-3">Call</strong>
                     <p class="mb-0">
                        <a href="tel: +63 917 707 7257">
                        +63 917 707 7257
                        </a>
                     </p>
                  </div>
               ...
               <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                  <!-- <form action="#" method="get" class="custom-form contact-form" role="form">
                     ...
                     <script async defer src="https://formfacade.com/include/116043839776904207353/form/1FAIpQLSdCOVBXLVFuzIDS8OPHuyX25W_CiRccx7Wx5ZgpvxhyBkQBfw/clean.js?div=ff-compose"></script>
               </div>
            </div>
         </div>
         </div>
